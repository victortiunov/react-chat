...
export function fetchAllChats() {
  return (dispatch, getState) => {
    ...
    return callApi(routes.CHATS, token)
      .then(json =>
        dispatch({
...
export function fetchMyChats() {
  return (dispatch, getState) => {
    ...
    return callApi(routes.MY_CHATS, token)
      .then(json =>
        dispatch({
...
export function fetchChat(chatId) {
  return (dispatch, getState) => {
    ...
    return callApi(`${routes.CHATS}/${chatId}`, token)
      .then((json) => {
        dispatch({
...
export function deleteChat(chatId) {
  return (dispatch, getState) => {
    ...
    return callApi(`${routes.CHATS}/${chatId}`, token, { method: 'DELETE' })
      .then((json) => {
        dispatch({
