...
export const FETCH_MY_CHATS_FAILURE = Symbol('chats/FETCH_MY_CHATS_FAILRE');
...
export const FETCH_ALL_CHATS_FAILURE = Symbol('chats/FETCH_ALL_CHATS_FAILRE');
...
export const FETCH_CHAT_FAILURE = Symbol('chats/FETCH_CHAT_FAILRE');
